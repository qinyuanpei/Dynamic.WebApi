...
using Abp.DynamicWebApi.Sessions;
using Abp.DynamicWebApi.Web.Controllers.Results;
using Abp.DynamicWebApi.Web.Models;
using Abp.DynamicWebApi.Web.Models.Account;
...
{
    public class AccountController : DynamicWebApiControllerBase
    {
